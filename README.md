...
## Description
Ce projet contient la structure de la base de données pour l'application de covoiturage écologique EcoRide. La base de données gère les uti$
...
### Fonctionnement
L'interface présente un message explicatif et deux boutons de choix. La sélection est enregistrée en base de données et détermine les fonct$
